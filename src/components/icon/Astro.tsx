...
export default function Astro(): React.ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 128 128" className="svg-icon">
      <path
        className="animate-breathe-light dark:animate-breathe-dark"
